...
export function Home(props: any) {
    ...
    return (
        <main class={"grid grid-flow-col dark:text-white min-h-max w-full relative"}>
            <button
            ...
            <div class={"dark:bg-slate-900 p-16 lg:pl-52 lg:pr-52 max-w-[100%]"}>
                <div>
                    ...
                    <div
                        class={
                            " box-border z-20 p-3 overflow-auto transition-all"
                        }
                    >
                        ...
                        <Show
                            when={!german()}
                            fallback={<h2 class="p-4 text-xl pt-6 font-semibold">{"Sprachen"}</h2>}
                        >
                        ...
                        <div>
                            <Show
                                when={!german()}
                                fallback={<h2 class="p-4 text-xl pt-6 font-semibold">{"Fähigkeiten"}</h2>}
                            >
                            ...
                            <Show
                                when={!german()}
                                fallback={<div>{"Programmier Sprachen: Javascript/Typescript, Python, Java, GDScript (Gamedev)"}
                                    <br />
                                    ...
                                    <br />
                                    {"Frameworks/Technologien: React/Next.js, Svelte, SolidJS/SolidStart, Django, NodeJS, Docker, Godot"}</div>} >
                                <div>
                    ...
                    <div class="xl:grid xl:grid-cols-2 gap-5">
                        <div class=" flex flex-col gap-2 p-4">
                            ...
                            >
                                <div>
                                    ...
                                    is a realtime collaborative task organizer built with
                            ...
                            <details class="flex flex-col gap-32">
                                <summary class="cursor-pointer rounded p-2 text-white bg-[#323b4c] w-fit">More</summary>
                                <div>
                                    <div class=" w-full">
                        ...
                        <div class=" flex flex-col gap-2 p-4">
                            ...
                            >
                                <div>
                                    ...
                                    is a discord bot which uses Openai's api/(function calling) for chatting and
                                    command execution with natural language.                                </div>
                            </Show>
                        ...
                        <div class="flex flex-col gap-2 p-4">
                            <Show
                                ...
                                fallback={
                                    <div>
                                        <a href="https://github.com/moonymax/socketRPC" class="text-blue-600">
                                            SocketRPC
                                        </a>{" "}
                                        ist eine typesafe Websocket-basierte Remote Procedure Call Library, die von tRPC inspiriert ist.
                                    </div>
                                }
                            >
                                <div>
                                    ...
                                    is a typesafe websocket based Remote Procedure Call library inspired by tRPC.
                                </div>
                            </Show>
                            <div class="flex flex-row gap-1 mt-2">
                                <a title="™/®Microsoft, Public domain, via Wikimedia Commons" class="rounded" href="https://commons.wikimedia.org/wiki/File:Typescript_logo_2020.svg">
                                    <img width="25" alt="Typescript logo 2020" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Typescript_logo_2020.svg/512px-Typescript_logo_2020.svg.png" />
                                </a>
                            </div>
                            <details class="flex flex-col">
                                <summary class="cursor-pointer rounded p-2 text-white bg-[#323b4c] w-fit">More</summary>
                        ...
                        <div class="flex flex-col gap-2 p-4">
                            <Show
                                ...
                                fallback={
                                    <div>
                                        <a href="https://github.com/moonymax/st3" class="text-blue-600">
                                            Mein SolidStart-Starter
                                        </a>{" "}
                                        ist eine Vorlage für die schnelle Erstellung einer SolidStart-Anwendung. Sie verwendet einen E-Mail-basierten Auth-flow, Websockets (inkompatibel mit serverless functions), Prisma (Sqlite) und Tailwind.
                                    </div>
                                }
                            >
                                <div>
                                    ...
                                    is a template for quickly creating a SolidStart Application. It is using an email based auth flow, Websockets (Incompatible with serverless functions), Prisma (Sqlite) and Tailwind.
                                </div>
                            </Show>
                            <div class="flex flex-row gap-1 mt-2">
                                <TechTag>
                        ...
                        <div class="flex flex-col gap-2 p-4">
                            <Show
                                ...
                                fallback={
                                    <div>
                                        ...
                                        ist eine Static SPA, entwickelt mit Svelte für Effektnotizen am Set eines
                            ...
                            >
                                <div>
                                    ...
                                    is a static SPA, written with Svelte, for on set effects notes for a
                            ...
                            <Show
                                ...
                                fallback={
                                    <div>
                                        ...
                                        Sie untersuchen die zinsbereinigten Renditen des S&P500 sowie die Auswirkungen von Zinsänderungen, Zinsen und KGV auf künftige Renditen.
                                    </div>
                                }
                            >
                                <div>
                                    <a href="https://github.com/moonymax/DataAnalysisNotebooks" class="text-blue-600">
                                        These are some old data analysis Projects.
                                    </a>{" "}
                                    They are investigating rate adjusted S&P500 returns as well as the effects of rate changes, rates and pe on future returns.
                                </div>
                            </Show>
                            <div class="flex flex-row gap-1 mt-2">
                                <TechTag>
                                    <a title="Marc Garcia, BSD &lt;http://opensource.org/licenses/bsd-license.php&gt;, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Pandas_logo.svg">
                                        <img height="15" width="45" alt="Pandas logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/Pandas_logo.svg/256px-Pandas_logo.svg.png" />
                ...
                <Show
                    when={!german()}
                    fallback={<h2 class="p-4 text-xl pt-6 font-semibold">{"Über Mich"}</h2>}
                >
