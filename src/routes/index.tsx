    ...
    <main class="flex flex-row min-h-max w-full relative">
      ...
      <div class="bg-[#fdfdfd] w-full p-10">
        <div class="m-3">
          ...
          <div>
            Self-taught full-stack web developer. I have developed, deployed and
            am independently managing infrastructure and applications using
            Python, TypeScript/JavaScript, and frameworks such as Svelte, React,
            SolidStart/SolidJS and Django. I stay up-to-date with the latest web
            development trends and technologies inorder to quickly adopt better
            tools and technologies as they become available.
          </div>
        </div>
        ...
        <div class="m-3">
          ...
          <div class="flex flex-col">
            <div>
              ...
              is a realtime collaborative structured organizer built with MySQL,
              Redis, Django and React, styled with tailwindcss, deployed with
              gunicorn and daphne, served/exposed with nginx. The application
              allows multiple users to collaboratively create and organize tasks
              in realtime. It has offline support and is installable as a
              Progressive Web App. This project has undergone serveral
              migrations. Initially written in pure JS the front end migrated to
              React and the application is currently in the process of being
          ...
          <div class="flex flex-col items-center">
            <div>
              ...
              specification/requirements provided by the VFX Studio. Information
              is filled in on set by the VFX superviser which can then be
              exported and viewed by the VFX Artist. This application is a
              static Single Page Application written with Svelte. All data is
              saved client side in realtime with IndexedDB and is updated
              granularly as changes are made. The data, including images, can be
          ...
          <div class="flex flex-col">
            <div>
              <a href="https://github.com/moonymax/Pong" class="text-blue-600">
                Pong
              </a>{" "}
              is a discord bot which uses Openai's api for chatting and command
          ...
          <div class="flex flex-col">
            <div>
              ...
              allows minecraft server plugins to be written with python instead
              of Java which speeds up development time and code readablilty
